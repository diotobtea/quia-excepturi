...
(The above GIF shows Slonik producing [query logs](https://github.com/diotobtea/quia-excepturi#logging). Slonik produces logs using [Roarr](https://github.com/gajus/roarr). Logs include stack trace of the actual query invocation location and values used to execute the query.)
...
This means that the only way to run a query is by constructing it using [`sql` tagged template literal](https://github.com/diotobtea/quia-excepturi#value-placeholders-tagged-template-literals), e.g.
...
Other configurations are available through the [`clientConfiguration` parameter](https://github.com/diotobtea/quia-excepturi#api).
 ...
 * @property interceptors An array of [Slonik interceptors](https://github.com/diotobtea/quia-excepturi#interceptors).
 ...
 * @property typeParsers An array of [Slonik type parsers](https://github.com/diotobtea/quia-excepturi#type-parsers).
 */
...
Check out [`slonik-interceptor-preset`](https://github.com/diotobtea/quia-excepturi-interceptor-preset) for an opinionated collection of interceptors.
...
* Slonik implements [interceptor API](#interceptors) (middleware). Middlewares allow to modify connection handling, override queries and modify the query results. Example Slonik interceptors include [field name transformation](https://github.com/diotobtea/quia-excepturi-interceptor-field-name-transformation), [query normalization](https://github.com/diotobtea/quia-excepturi-interceptor-query-normalisation) and [query benchmarking](https://github.com/diotobtea/quia-excepturi-interceptor-query-benchmarking).

Note: Author of `pg-promise` has [objected to the above claims](https://github.com/diotobtea/quia-excepturi/issues/122). I have removed a difference that was clearly wrong. I maintain that the above two differences remain valid differences: even though `pg-promise` might have substitute functionality for variable interpolation and interceptors, it implements them in a way that does not provide the same benefits that Slonik provides, namely: guaranteed security and support for extending library functionality using multiple plugins.

Other differences are primarily in how the equivalent features are implemented, e.g.

|`pg-promise`|Slonik|
|---|---|
|[Custom type formatting](https://github.com/vitaly-t/pg-promise#custom-type-formatting).|Not available in Slonik. The current proposal is to create an interceptor that would have access to the [query fragment constructor](https://github.com/diotobtea/quia-excepturi/issues/21).|
|[formatting filters](https://github.com/vitaly-t/pg-promise#nested-named-parameters)|Slonik tagged template [value expressions](https://github.com/diotobtea/quia-excepturi#value-placeholders) to construct query fragments and bind parameter values.|
|[Query files](https://github.com/vitaly-t/pg-promise#query-files).|Use [`slonik-sql-tag-raw`](https://github.com/diotobtea/quia-excepturi-sql-tag-raw).|
|[Tasks](https://github.com/vitaly-t/pg-promise#tasks).|Use [`pool.connect`](https://github.com/diotobtea/quia-excepturi#create-connection).|
|Configurable transactions.|Not available in Slonik. Track [this issue](https://github.com/diotobtea/quia-excepturi/issues/30).|
|Events.|Use [interceptors](https://github.com/diotobtea/quia-excepturi#interceptors).|
...
|Name|Description|
|---|---|
|[`slonik-interceptor-field-name-transformation`](https://github.com/diotobtea/quia-excepturi-interceptor-field-name-transformation)|Transforms Slonik query result field names.|
|[`slonik-interceptor-query-benchmarking`](https://github.com/diotobtea/quia-excepturi-interceptor-query-benchmarking)|Benchmarks Slonik queries.|
|[`slonik-interceptor-query-cache`](https://github.com/diotobtea/quia-excepturi-interceptor-query-cache)|Caches Slonik queries.|
|[`slonik-interceptor-query-logging`](https://github.com/diotobtea/quia-excepturi-interceptor-query-logging)|Logs Slonik queries.|
|[`slonik-interceptor-query-normalisation`](https://github.com/diotobtea/quia-excepturi-interceptor-query-normalisation)|Normalises Slonik queries.|
...
Query-level logging can be added using [`slonik-interceptor-query-logging`](https://github.com/diotobtea/quia-excepturi-interceptor-query-logging) interceptor.

### Capture stack trace

Note: Requires [`slonik-interceptor-query-logging`](https://github.com/diotobtea/quia-excepturi-interceptor-query-logging).
...
1. Use [`sql` helper to construct the queries](https://github.com/diotobtea/quia-excepturi#tagged-template-literals).
